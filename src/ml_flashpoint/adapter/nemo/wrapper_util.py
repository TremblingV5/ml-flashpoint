...
def wrap_trainer_and_auto_resume_with_mlflashpoint(
    ...
    Args:
        ...
        files_per_rank: Optional. The number of files per rank for writing checkpoint data. Defaults to 1.
    ...
    pool_config = BufferPoolConfig(
        ...
        num_buffers=files_per_rank * NUM_OF_BUFFERS_PER_OBJECT,
...
def wrap_trainer_checkpoint_io_with_mlflashpoint(
    ...
    if files_per_rank < 1:
        raise ValueError(f"files_per_rank must be >= 1, got {files_per_rank}.")
